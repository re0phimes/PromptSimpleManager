  ...
  <aside class="w-64 border-r border-gray-700 flex flex-col">
    ...
    <nav class="flex-1 overflow-auto p-4">
      <div class="space-y-2">
        ...
        >
          <button
            class="flex-grow text-left px-4 py-2 rounded hover:bg-gray-700 transition-colors w-full overflow-hidden"
          ...
          <button
            ...
            class="p-2 text-gray-400 hover:text-white opacity-0 group-hover:opacity-100 transition-opacity"
          >
    ...
    <div class="p-4 border-t border-gray-700">
      <button
        ...
        class="w-full px-4 py-2 bg-gray-700 text-white rounded hover:bg-gray-600 transition-colors"
